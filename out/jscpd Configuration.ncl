...
let rec _js2n__-refsenv
    = {
      "_js2n__-:definitions/color!contract" =
        _js2n__-prdslib.contract_from_predicate
            (_js2n__-prdslib.oneOf
              [
                _js2n__-refsenv."_js2n__-:definitions/colorPreset!predicate",
                _js2n__-refsenv."_js2n__-:definitions/colorHex!predicate"
              ]),
      "_js2n__-:definitions/colorHex!predicate" =
        _js2n__-prdslib.allOf
            [
              _js2n__-prdslib.isType '"String",
              _js2n__-prdslib.strings.pattern "([0-9a-fA-F]{3}){1,2}"
            ],
      "_js2n__-:definitions/colorPreset!predicate" =
      ...
      "_js2n__-:definitions/format!contract" =
        _js2n__-prdslib.contract_from_predicate
            (_js2n__-prdslib.enum
              [
                "abap",
    ...
    in
  {
      ...
      exitCode
        ...
        | optional,
      format
        | Array _js2n__-refsenv."_js2n__-:definitions/format!contract"
        ...
        | {
          badge
            | {
              ...
              style
                | _js2n__-prdslib.contract_from_predicate
                  (_js2n__-prdslib.enum [ "flat", "classic" ])
      ...
      store
        | _js2n__-prdslib.contract_from_predicate
          (_js2n__-prdslib.enum [ "leveldb", "redis" ])
